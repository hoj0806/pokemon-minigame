    ...
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-57px)] gap-20 p-6">
      ...
      >
        <h1 className="font-galmuri cursor-pointer relative text-5xl md:text-7xl xl:text-9xl font-extrabold transform rotate-[-5deg] transition-transform duration-300 ease-out drop-shadow-[4px_4px_0px_rgba(0,0,0,0.6)] hover:scale-110 hover:rotate-0 hover:drop-shadow-[6px_6px_0px_rgba(0,0,0,0.8)]">
          <span className="bg-gradient-to-br from-yellow-200 via-yellow-400 to-amber-500 bg-clip-text text-transparent">Poke</span><span className="bg-gradient-to-br from-red-400 to-red-600 bg-clip-text text-transparent">Flip</span>
          ...
          <span className="absolute top-1 left-1 text-black opacity-40 -z-10">PokeFlip</span>
          <span className="absolute top-2 left-2 text-black opacity-20 -z-20">PokeFlip</span>
        </h1>
      </motion.div>
